...
#kobo_dico(form)
dico <- read.csv(paste("data/dico2_",form,".csv",sep = ""), encoding = "UTF-8", na.strings = "")
#rm(form)
...
for( i in 1:nrow(chapters) )
{
  ...
  cat("dico <- read.csv(paste0(mainDirroot,\"/data/dico2_\",form,\".csv\"), encoding=\"UTF-8\", na.strings=\"\")", file = chapter.name , sep="\n", append=TRUE)
